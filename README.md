...
curl -o .repo/local_manifests/manifest_ptp_avtp.xml -L https://raw.githubusercontent.com/loebelch/android_local_manifest/android-17.0/manifest_ptp_avtp.xml
```
